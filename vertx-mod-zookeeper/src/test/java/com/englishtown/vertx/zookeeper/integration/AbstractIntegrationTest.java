...
import com.englishtown.vertx.zookeeper.hk2.ZooKeeperBinder;
...
public abstract class AbstractIntegrationTest extends TestVerticle {
    ...
    protected void setup() throws Exception {
        ...
        ServiceLocatorUtilities.bind(locator, new ZooKeeperBinder(), new HK2WhenBinder(), new AbstractBinder() {
            @Override
